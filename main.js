$(function(){
           ...
           for (var i = 0; i < window.localStorage.length; i++) {
               if ( /^tracker/.test(window.localStorage.key(i))) {
                 ...
                 var process = '<span class="entry"><span class="date">' +
                               ...
                               '</span>stress ' + stress + ' <span class="color" style="background-color:' + color['stress'][stress] + '"></span>' +
                               'mood ' + mood + ' <span class="color" style="background-color:' + color['mood'][mood] + '"></span>' +
  ...
  $('a.submit').click(function(){
    if (feels['stress'] == 0 || feels['mood'] == 0 || feels['energy'] == 0 || feels['fog'] == 0) {
      $('.alert').show();
